...
public class Constants {
    public static final String FIREBASE_URL = "https://nfc-tasks.firebaseio.com/";
    public static final String NEST_CLIENT_ID = "24b7b00f-2695-46a9-974f-56a91c8071ea";
    public static final String NEST_CLIENT_SECRET = "lbIvaQPGiNHDapkT2vL2VbqQ8";
